...
if ( ! function_exists( 'igrowmacon_get_customizer_image_info' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_customizer_image_info( $name ) {
		...
		$id = igrowmacon_get_image_id( $image_url );
	...
	} // igrowmacon_get_customizer_image_info()
endif;

if ( ! function_exists( 'igrowmacon_get_featured_images' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_featured_images( $postID ) {
	...
	} // igrowmacon_get_featured_images()
endif;

if ( ! function_exists( 'igrowmacon_get_image_id' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_image_id( $image_url ) {
	...
	} // igrowmacon_get_image_id()
endif;

if ( ! function_exists( 'igrowmacon_get_svg' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_svg( $svg ) {

		if ( empty( $svg ) ) { return; }

		$list = igrowmacon_get_svg_list();
...
if ( ! function_exists( 'igrowmacon_get_svg_list' ) ) :
	...
	function igrowmacon_get_svg_list() {
		...
		/**
		 * The igrowmacon_svgs filter
		 */
		$list = apply_filters( 'igrowmacon_svgs', $list );

		return $list;

	} // igrowmacon_get_svg_list()
endif;

if ( ! function_exists( 'igrowmacon_get_thumbnail_url' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_thumbnail_url( $postID, $size = 'thumbnail' ) {
	...
	} // igrowmacon_get_thumbnail_url()
endif;

if ( ! function_exists( 'igrowmacon_get_video_thumb' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_video_thumb( $embed_code ) {

		$return = '';

		$service = igrowmacon_get_video_service( $embed_code );
		$videoID = igrowmacon_get_video_id( $service, $embed_code );
		...
		if ( preg_match( '~youtu~', $embed_code ) ) {
			...
			$thumb 	= igrowmacon_get_vimeo_thumb( $video_id[1] );
	...
	} // igrowmacon_get_video_thumb()
endif;

if ( ! function_exists( 'igrowmacon_get_video_service' ) ) :
	function igrowmacon_get_video_service( $string ) {
		 ...
		 */
		$checks 	= apply_filters( 'igrowmacon-video-services', $checks, $string );
		$service 	= FALSE;
	...
	} // igrowmacon_get_video_service()
endif;

if ( ! function_exists( 'igrowmacon_get_video_id' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_video_id( $service, $string ) {
...
if ( ! function_exists( 'igrowmacon_get_vimeo_thumb' ) ) :
	/**
	 ...
	 */
	function igrowmacon_get_vimeo_thumb( $videoid ) {
	...
	} // igrowmacon_get_vimeo_thumb()
endif;

if ( ! function_exists( 'igrowmacon_the_svg' ) ) :
	/**
	 ...
	 * @return 	mixed 					The SVG code
	 */
	function igrowmacon_the_svg( $svg ) {

		echo igrowmacon_get_svg( $svg );
