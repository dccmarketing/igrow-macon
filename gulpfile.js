 ...
 * sudo npm install --save-dev gulp-sourcemaps gulp-autoprefixer gulp-filter gulp-merge-media-queries gulp-cssnano gulp-sass gulp-concat gulp-uglify gulp-notify gulp-imagemin gulp-rename gulp-wp-pot gulp-sort gulp-parker
 *
 * Implements:
...
gulp.task( 'styles', function () {
	gulp.src( watch.styles )
		...
		.pipe( plugins.parker({ title: 'Parker Test Results' }) )
