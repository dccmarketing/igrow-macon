...
/**
 * Methods for setting up the iGrow Macon theme.
 *
 * @since 			1.0.0
 * @package 		iGrow_Macon
 * @subpackage 		iGrow_Macon/classes
 */
class iGrow_Macon_Setup {
	...
	public function content_width() {
		...
		$GLOBALS['content_width'] = apply_filters( 'igrowmacon_content_width', 640 );
	...
	public function enqueue_admin( $hook ) {
		...
		wp_enqueue_style( 'igrowmacon-admin', get_stylesheet_directory_uri() . '/admin.css' );
		...
		wp_enqueue_script( 'igrowmacon-admin', get_stylesheet_directory_uri() . '/assets/js/admin.min.js', array( 'jquery', 'media-upload', 'jquery-ui-datepicker', 'wp-color-picker', 'timepicker', 'jquery-ui-slider' ), PARENT_THEME_VERSION, true );
	...
	public function enqueue_customizer_controls() {
		...
		wp_enqueue_script( 'igrowmacon-customizer-controls', get_stylesheet_directory_uri() . '/assets/js/customizer-controls.min.js', array( 'jquery', 'customize-controls' ), PARENT_THEME_VERSION, true );
	...
	public function enqueue_customizer_scripts() {
		...
		wp_enqueue_script( 'igrowmacon-customizer', get_stylesheet_directory_uri() . '/assets/js/customizer.min.js', array( 'jquery', 'customize-preview' ), PARENT_THEME_VERSION, true );
	...
	public function enqueue_customizer_styles() {
		...
		wp_enqueue_style( 'igrowmacon-customizer-style', get_stylesheet_directory_uri() . '/customizer.css', 10, 2 );
	...
	public function enqueue_login() {
		...
		wp_enqueue_style( 'igrowmacon-login', get_stylesheet_directory_uri() . '/login.css', 10, 2 );
	...
	public static function fonts_url() {
		...
		$return 	= '';
		$families 	= '';
		$fonts[] 	= array( 'font' => 'Open Sans', 'weights' => '400,700', 'translate' => esc_html_x( 'on', 'Open Sans font: on or off', 'igrow-macon' ) );
	...
	public function text_domain() {
		...
		load_theme_textdomain( 'igrow-macon', get_stylesheet_directory() . '/languages' );
	...
	public function widgets_init() {
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Sidebar', 'igrow-macon' ),
			'id'            => 'sidebar',
			'description'   => esc_html__( 'Add widgets here.', 'igrow-macon' ),
