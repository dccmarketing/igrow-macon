...
class iGrow_Macon_Field {
	...
	protected function get_default_aria_text() {
		...
		if ( 'select' === $this->props['type'] ) {
			...
			return __( 'Select an option.', 'igrow-macon' );

		}

		$arias['select-formidable-form'] 	= __( 'Select a form.', 'igrow-macon' );
		$arias['select-menu'] 				= __( 'Select a menu.', 'igrow-macon' );
		$arias['select-page'] 				= __( 'Select a page.', 'igrow-macon' );
		$arias['select-slider'] 			= __( 'Select a slider.', 'igrow-macon' );
		$arias['select-taxonomy'] 			= __( 'Select a taxonomy.', 'igrow-macon' );
	...
	protected function get_default_blank_text() {
		...
		if ( 'select' === $this->props['type'] ) {
			...
			return __( '- Select -', 'igrow-macon' );

		}

		$blanks['select-formidable-form'] 	= __( '- Select form -', 'igrow-macon' );
		$blanks['select-menu'] 			= __( '- Select menu -', 'igrow-macon' );
		$blanks['select-page'] 			= __( '- Select page -', 'igrow-macon' );
		$blanks['select-slider'] 			= __( '- Select slider -', 'igrow-macon' );
		$blanks['select-taxonomy'] 		= __( '- Select taxonomy -', 'igrow-macon' );
	...
	protected function get_default_error_text() {
		...
		if ( 'select' === $this->props['type'] ) {
			...
			return __( 'There was an error with the selections for this field.', 'igrow-macon' );

		}

		$errors['select-formidable-form'] 	= __( 'Please publish a form to use the form select field.', 'igrow-macon' );
		$errors['select-menu'] 				= __( 'Please publish a menu to use the menu select field.', 'igrow-macon' );
		$errors['select-page'] 				= __( 'Please publish a page to use the page select field.', 'igrow-macon' );
		$errors['select-slider'] 			= __( 'Please publish a slider to use the slider select field.', 'igrow-macon' );
		$errors['select-taxonomy'] 			= __( 'Please create a taxonomy to use the taxonomy select field.', 'igrow-macon' );
	...
	protected function get_default_placeholder() {
		...
		$holds['date'] = __( 'Select date', 'igrow-macon' );
		$holds['time'] = __( 'Select time', 'igrow-macon' );
	...
	protected function get_default_properties() {
		...
		$default 				= array();
		$default['description'] = __( '', 'igrow-macon' );
		...
		if ( 'file-upload' === $this->props['type'] ) {
			...
			$default['labels']['remove'] 	= __( 'Remove file', 'igrow-macon' );
			$default['labels']['upload'] 	= __( 'Choose/Upload file', 'igrow-macon' );

		}

		if ( 'image-upload' === $this->props['type'] ) {

			$default['labels']['remove'] 	= __( 'Remove image', 'igrow-macon' );
			$default['labels']['upload'] 	= __( 'Choose/Upload image', 'igrow-macon' );
	...
	protected function set_selections() {
		...
		if ( 'select-formidable-form' === $this->props['type'] ) {
			...
			$sliders 	= igrowmacon_get_posts( 'soliloquy', $this->props['query'], 'select-slider' );
