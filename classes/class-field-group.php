...
class iGrow_Macon_Field_Group {
	...
	protected function get_default_properties() {
		...
		$default['labels']['add'] 		= __( 'Add Field', 'igrow-macon' );
		$default['labels']['edit'] 		= __( 'Edit Field', 'igrow-macon' );
		$default['labels']['header'] 	= __( 'Field Name', 'igrow-macon' );
		$default['labels']['remove'] 	= __( 'Remove Field', 'igrow-macon' );
			...
			<div class="repeater-handle">
				...
				<button aria-expanded="true" class="btn-edit repeater-edit-btn" type="button">
					<span class="screen-reader-text"><?php
						...
						echo esc_html( $this->props['labels']['edit'], 'igrow-macon' );
			...
			<div class="repeater-content">
				...
				<div>
					<a class="remove-repeater" href="#"><?php
						...
						echo esc_html( apply_filters( PARENT_THEME_SLUG . '_repeater_remove_link_label', $this->props['labels']['remove'] ), 'igrow-macon' );
...
*/
		...
		/*?><p class="wrap-field"><?php*/
			...
			$new_field = new iGrow_Macon_Field( $type, $atts, $props );
	...
	protected function output_hidden_repeater_title_field( $uid, $values ) {
		...
		$field 					= new iGrow_Macon_Field( 'hidden', $atts, array() );
		$field->display_field();
