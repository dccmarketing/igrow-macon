 ...
 */
class iGrow_Macon_Metabox_Post_Format {
	...
	public function __construct() {
		...
		$nonce 						= 'nonce_igrowmacon_post_format';
		...
		$props['name'] 				= __( 'Post Format Data', 'igrow-macon' );
		$props['screen'] 			= 'post';

		$this->metabox 				= new iGrow_Macon_Metabox( $props, $nonce, $fields, $conditions );
