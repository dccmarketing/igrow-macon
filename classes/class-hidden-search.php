 ...
 */
class iGrow_Macon_Hidden_Search {
	...
	public function hooks() {
		...
		add_action( 'igrowmacon_body_top', array( $this, 'add_hidden_search' ), 15 );

		add_filter( 'igrowmacon_search_form_class', array( $this, 'add_class_to_form' ), 10, 1 );
		add_filter( 'igrowmacon_search_field_class', array( $this, 'add_class_to_field' ), 10, 1 );
		add_filter( 'igrowmacon_search_button_class', array( $this, 'add_class_to_button' ), 10, 1 );
